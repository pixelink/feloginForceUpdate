# -*- coding: utf-8 -*-
#
# FeLogin Force userdata change documentation build configuration file, created by
# TYPO3 extension sphinx on Thu, 14 Apr 2016 23:07:20 +0200.
#
...
project = u'FeLogin Force userdata change'
copyright = u'2016, Benjamin Riezler'
...
htmlhelp_basename = 'felogin_force_updatedoc'
...
latex_documents = [
    ('Index', 'felogin_force_update.tex', u'FeLogin Force userdata change',
     u'Benjamin Riezler', 'manual'),
]
...
pdf_documents = [
    ('Index', 'felogin_force_update', u'FeLogin Force userdata change',
     u'Benjamin Riezler'),
]
...
texinfo_documents = [
    ('Index', 'felogin_force_update', u'FeLogin Force userdata change',
     u'Benjamin Riezler', 'FeLogin Force userdata change', 'One line description of project.',
     'Miscellaneous'),
]
